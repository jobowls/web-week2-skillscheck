...
let faveColors = ['red', 'orange', 'gray'];
...
const me = {firstName: 'your name', superHeroName: 'Smooth Sailor', homeTown: 'Ogden', superPowers: ['master of the seas', 'anchor of the deep', 'persuader of mermaids'], superPowerXP: Math.floor(Math.random() * 100) + 1, profileImage: src="getImagePath(https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }. jpg)"}
